...
public class Test {
    ...
    public Test(){
        ...
        Course c = new Course("100", "comPro","Software",3);
        Course o = new Course("101", "ooad","Software",3);
        Course d = new Course("102", "dataCom","Network",3);
        Course t = new Course("103", "toc","Software",3);
        Course digi = new Course("104", "digital","Hardware",3);
