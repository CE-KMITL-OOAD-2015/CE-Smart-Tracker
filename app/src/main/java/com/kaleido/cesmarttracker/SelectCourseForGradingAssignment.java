...
//คลาสนี้ไม่มีอะไร ไว้ลิ้งกับเมนูหลักก็พอ
public class SelectCourseForGradingAssignment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_course_for_grading_assignment);
...
//        courses.add(c6);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(),ListAssignmentForGrading.class);
